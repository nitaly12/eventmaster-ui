...
export function DeleteCategoryModal({ open, onClose, onConfirm }) {
  useEffect(() => {
    if (!open) return;
    const onKeyDown = (e) => {
  ...
  return (
    <div className={styles.modalOverlay} onClick={onClose} role="presentation">
      ...
      >
        ...
        <h2 id="delete-category-title" className={styles.deleteModalTitle}>
          Do you want to remove this event category?
        </h2>
